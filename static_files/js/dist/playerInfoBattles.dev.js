...
$(".battleIconSmall").addClass("list-inline-item d-inline-block d-md-none mr-0"); // Color styling for certain text
...
function sortBattles() {
  var sortType = $("#battleSortType").text();
  var sortOrder = $("#battleSortOrder").text(); // Got the general sorting code from: http://jsfiddle.net/hibbard_eu/C2heg/
  ...
  switch (sortType) {
    ...
    case "Level Difference":
      {
        $("#battleDisplay").html($("#battleDisplay").children().sort(function (a, b) {
          var num1 = parseFloat($(a).find(".level-difference").text());
          var num2 = parseFloat($(b).find(".level-difference").text());
