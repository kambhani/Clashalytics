$(document).ready(function() {
  ...
  // Creates search selection for both country and season
  amagiDropdown({
  ...
  amagiDropdown({
    elementId: "seasonSelect",
    searchButtonInnerHtml: "Change",
    bodyMessage: "Search via the search bar and then double-click on the desired season",
    href: "/leaderboards/players",
    dynamicHref: "season"
  });
  ...
  $(function() {
    $(".display-toggle").change(function() {
      ...
      const displayClass = ($(this).attr("data-column") < 3) ? "d-block" : "d-flex";
